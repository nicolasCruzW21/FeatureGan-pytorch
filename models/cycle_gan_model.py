...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            visual_names_A = []
            visual_names_B = ['real_A','real_B', 'fake_A','fake_A_D','squeeze_real_1', 'squeeze_real_2','squeeze_fake_1','squeeze_fake_2']
        ...
        if self.isTrain:
            self.model_names = ['G_B', 'D_B', 'D_B_G', 'D_B_M']
        ...
        if self.isTrain:  # define discriminators
            ...
            self.netD_B = networks.define_D(387, 72, "n_layers", 
                                            2, opt.norm, opt.init_type, opt.init_gain, self.gpu_ids, True)
        ...
        if self.isTrain:
            ...
            self.optimizer_D_G = torch.optim.Adam(itertools.chain(self.netD_B_M.parameters(), self.netD_B_G.parameters()), lr=opt.lr*2, betas=(opt.beta1, 0.999))
